<template>
  <div>
    <div class="featured px-3 bg-blue-100 ">
      <div class="container h-auto mx-auto px-3 py-10 flex flex-col" v-for="content in featured" :key="content.slug">
        ...
        <nuxt-link :to="'blog/'+content.slug">
          ...
          <small v-for="tag in content.tags " :key="content.tags" class="ml-1 text-center px-1 inline-block w-25 rounded bg-red-300">{{tag}}</small>
