    ...
    <div class="article-head w-full h-auto bg-indigo-200 mb-8">
      <div class="flex flex-col">
        ...
        <div class="flex flex-row items-center justify-center pb-10">
          <img src="https://avatars2.githubusercontent.com/u/34214453" alt="avatar" class="rounded-full h-10 w-10 shadow">
...
<script>
  export default {
    async asyncData({ $content, params, error }) {
      ...
      try {
        const article = await $content(params.slug, error).fetch()
